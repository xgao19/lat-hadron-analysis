...
) -> tuple[DAM0VsBZSeries, ...]:
    series: list[DAM0VsBZSeries] = []
...
def plot_da_m0_vs_bz(
    output_path: str | Path,
    series: tuple[DAM0VsBZSeries, ...],
    *,
    component: str,
    nstates: int,
    title: str | None = None,
...
def plot_da_m0_from_fit_tables(
    output_path: str | Path,
    fit_tables_by_bT: dict[int, str | Path],
    *,
    component: str,
        ...
        "cells": [
            {
                ...
                "source": [
                    "# DA Plot Notebook\n",
                    "This notebook redraws grouped post-fit DA plots from existing output tables.\n",
            ...
            },
            {
                ...
                "source": [
                    ...
                    "from lqcd_analysis.DA.plotting import plot_da_grouped_outputs, plot_da_m0_from_fit_tables\n",
                    "from lqcd_analysis.DA.fourier import run_da_fourier_from_fit_outputs\n",
                ],
            },
            {
                "cell_type": "code",
            ...
            },
            {
                ...
                "source": [
                    "## Fourier Transform\n",
                    "This section recomputes the post-fit cosine transform from the existing grouped fit/sample tables only, so you can tune `x_values`, `zstep_fm`, and `interpolation_kind` without rerunning the DA fit.\n",
                ],
            },
            {
                "cell_type": "code",
                ...
                "source": [
                    ...
                    "fourier_outputs = run_da_fourier_from_fit_outputs(\n",
